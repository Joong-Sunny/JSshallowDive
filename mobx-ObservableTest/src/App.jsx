...
const App = observer(() => {
  ...
  const handleClick1 = () => {
    const newMetaObjects = Array.from(
      { length: 10 },
      (_, i) => new OriginalMetaObject()
    );
  ...
  return (
    <>
      ...
      <h1>Mobx Test</h1>
      <div className="card">
        <button onClick={handleClick1}>metaObject 10개 만들기</button>
        <button onClick={handleClick2}>1번 Metaobject 값 1더하기</button>
        <button onClick={handleClick3}>2번 Metaobject 값 1더하기</button>
      </div>
      <p>
